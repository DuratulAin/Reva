...
def retrieve_data():
    xano_api_endpoint_bg = 'https://x8ki-letl-twmt.n7.xano.io/api:3Ws6ADLi/bgdata'
    payload_bg = {}
    ...
    xano_api_endpoint_spectral = 'https://x8ki-letl-twmt.n7.xano.io/api:Qc5crfn2/spectraldata'
    payload_spectral = {}
